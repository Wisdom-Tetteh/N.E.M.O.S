 ...
 * @author admin
 */
public class Efficiency_DistanceVector extends JFrame {
    ...
    public Efficiency_DistanceVector(String psource) {
        source = psource;
    ...
    public double getDistenceVectorEfficiancy(Efficiency_Packet p) {
