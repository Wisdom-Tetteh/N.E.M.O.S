 ...
 * @author admin
 */
public class NemUp_ObjectFrame extends javax.swing.JInternalFrame {

    private MyTableModel tableModal = new MyTableModel();
    public NemUp_Main.Scan newScan;
    private NemUp_Start mainFrame;

    /**
     * Creates new form ObjectFrame
     */
    public NemUp_ObjectFrame(String title, NemUp_Start mainFrame) {
        initComponents();
        this.mainFrame = mainFrame;
        jTable1.setModel(tableModal);
        setTitle(title);
        newScan = new NemUp_Main.Scan(this, NemUp_Main.ObjectsList.getObject(title));
    }
    ...
    private void initComponents() {
        ...
        pane.setFont(new java.awt.Font("Georgia", 3, 12)); // NOI18N

        btnState.setFont(new java.awt.Font("Georgia", 3, 12)); // NOI18N
        ...
        jLabelState.setFont(new java.awt.Font("Georgia", 3, 12)); // NOI18N
    ...
    private void jMenuItemMsgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemMsgActionPerformed
        String msg = JOptionPane.showInputDialog(NemUp_ObjectFrame.this,
    ...
    public void ExecuteCmd(final String cmd, final String IPAdr) {
        ...
        new SwingWorker() {
            ...
            protected Object doInBackground() throws Exception {
                ...
                NemUp_Utilities.executeCmd(ta, cmd + IPAdr);
    ...
    public void ExecuteProcess(final String process) {
        ...
        new SwingWorker() {
            @Override
            protected Object doInBackground() throws Exception {
                NemUp_Utilities.ExecuteProcess(process);
                throw new UnsupportedOperationException("Not supported yet.");
            }
        }.execute();
    }
